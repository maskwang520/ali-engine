...
public class BenchMark {
	...
	private static void usage() {
		String msg = "java -Xms3072m -Xmx3072m  -XX:MaxDirectMemorySize=64m -XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:NewRatio=1 -cp ./benchmark_example_java-0.0.1-SNAPSHOT-jar-with-dependencies.jar com.alibabacloud.polar_race.com.alibabacloud.polar_race.benchmark.BenchMark threadCount writeCount keyLen_byte valueLen_byte db_path";
	...
	public static void main(String[] args) throws Exception {
		...
		//root.addAppender(new ConsoleAppender(new PatternLayout("%-d{yyyy-MM-dd HH:mm:ss}  [ %t:%r ] - [ %p ]  %m%n")));
...
//		int valueLen    = Integer.valueOf(args[3]);
        ...
        try {
        	for (int i = 0; i < threadCount && i < engineWriters.size(); i++) {
        ...
        long readTime = System.currentTimeMillis() + 1;
